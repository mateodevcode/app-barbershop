  ...
  return (
    <div className="w-full flex items-center justify-center h-svh p-4 bg-zinc-50">
      <div className="w-11/12 flex flex-col items-start justify-start relative h-full">
        ...
        <span className="text-2xl font-semibold text-zinc-800 mt-5 text-center w-full">
          Crea una cuenta{" "}
        </span>
        <span className="text-xl text-zinc-600">Blessed by God</span>
        ...
        <div className="grid gap-6 mt-12 w-full">
          <div className="grid gap-2 border-[1px] border-zinc-400 rounded-lg px-4 py-3 relative">
            ...
            <div className="relative flex items-center gap-4">
              <BsPerson className="h-4 w-4 text-muted-foreground" />
              <input
                type="name"
        ...
        <div className="w-full max-w-md flex flex-col gap-2 mt-6">
          ...
          <button className="flex items-center justify-center gap-4 bg-black text-white p-3 rounded-lg hover:bg-black/80 transition-colors w-full cursor-pointer select-none active:scale-95 duration-75">
            <FcGoogle />
            <span className=""> Registrate con Google</span>
          </button>
        </div>
